...
function TicketsListItem({ticket, index}) {

    const shortenMonthName = (fullMonthName) => {
        return fullMonthName.substring(0, 6); // Levágjuk az első három karaktert
      };
    ...
    <li key={index} className="tickets__item">
          ...
          <main className="tickets__item-main">
            ...
            <section className="tickets__item-info">
              ...
              <p className="tickets__item-info-seat"></p>
            </section>
          </main>
          <footer className="tickets__item-footer">
            <p className="tickets__item-order-barcode">{ticket.randomID}</p>
            <p className="tickets__item-order-code">#{ticket.randomID}</p>
          </footer>
        </li>
  )
}
